...
\keywords{Exploration vs Exploitation, Monte carlo tree search, UCT, Exploration parameter, Othello} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\AtBeginDocument{
	...
	\hypersetup{pdfkeywords={Exploration vs Exploitation, Monte carlo tree search, UCT, Exploration parameter, Othello}} % Set the PDF's keywords to your keywords
	\hypersetup{%
		colorlinks = true,
		linkcolor  = black
	}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/rank-015-3-sims}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/fourinarow}
...
\begin{figure}
	...
	\begin{minipage}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=\textwidth]{images/fourinarow-wide}
	...
	\begin{minipage}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=\textwidth]{images/fourinarow-narrow}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/fourinarow-significance}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{images/rank-015-3-sims.png}
